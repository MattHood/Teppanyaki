...
def main():
  ...
  plistpath = scriptpath + "/resources/Teppanyaki-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Teppanyaki-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Teppanyaki-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Teppanyaki-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Teppanyaki-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/Teppanyaki.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/Teppanyaki.iss",inplace=1):
