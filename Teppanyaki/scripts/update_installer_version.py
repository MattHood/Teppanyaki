...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=Teppanyaki Demo Installer\n"
      else:
        line="OutputBaseFilename=Teppanyaki Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the Teppanyaki Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the Teppanyaki installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=Teppanyaki Demo installer\n"
     else:
       line="SetupWindowTitle=Teppanyaki installer\n"
